# odyssey-sanity-gatsby-netlify-v5
...
1. Go to your [project’s API settings on manage.sanity.io](https://manage.sanity.io/projects/a1b8chk1/settings/api) and create a token with read rights.
